...
des Laptops (Core Ultra 7 155H) nutzt, für **~7 bis 10× schnellere Antworten** und
...
|---|---|---|
| **Antwort** (volle Pipeline, warm) | ~9 bis 10 Min | **~60 bis 85 s** (kurze Fragen ~40 s) |
| **Embedding** (Import) | ~0,6 bis 1,3 Chunks/s | **~5,3 Chunks/s (~8×)** |
...
noch auf der CPU, ~20 bis 30 s) und (2) der optionale **Faithfulness-Check** (~18 s).
...
Damit sind **~35 bis 45 s** pro Antwort realistisch (statt ~60 bis 85 s mit voller Sicherheit).
